        ...
        try:
            ...
            with open(filename, "rt") as text_file:
                ...
                if perc_reduc < 0 or perc_reduc > 100:
                    raise ValueError(f"{perc_reduc} is not in between 0 - 100. Please enter a number between these parameters.")
                else:
                    pass
            ...
            print(f"Error: Line {line} of {filename} contains 0 in the 'Fatal Crashes' or 'Cell phone use' Column")

        except (csv.Error, KeyError) as error:
            print(f"Error: line {line} of {filename} is"
